...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
       ...
       add(AdditionalDetails);
        ...
        String educationValues[] = {"Non-Graduate", "post-Graduate", "Doctrate", "Others",};
        ...
        pincode.setBounds(100,590,250,45);
        add(pincode);
        ...
        JLabel pincode1 = new JLabel("Pincode:");
        pincode1.setFont(new Font("Raleway",Font.BOLD,20));
        pincode1.setBounds(100,590,200,30);
        add(pincode1);
        pincode1.setVisible(false);
